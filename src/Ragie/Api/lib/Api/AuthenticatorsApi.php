...
/**
 * AuthenticatorsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class AuthenticatorsApi
{
    ...
    public function listAuthenticatorsRequest($cursor = null, $page_size = 10, string $contentType = self::contentTypes['listAuthenticators'][0])
    {
        ...
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling AuthenticatorsApi.listAuthenticators, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling AuthenticatorsApi.listAuthenticators, must be bigger than or equal to 1.');
        }
