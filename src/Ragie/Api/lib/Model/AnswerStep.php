 ...
 */
class AnswerStep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnswerStep';
    ...
    */
     ...
     *
     * @param string[]|null $other_resolved_question_ids A list of question ids that are no longer relevant to the current answer referenced by their IDs.
     *
     * @return self
     */
