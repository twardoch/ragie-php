 ...
 */
class AuthenticatorList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticatorList';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authenticators'] === null) {
            $invalidProperties[] = "'authenticators' can't be null";
        }
