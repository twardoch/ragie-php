 ...
 */
class AuthenticatorOnedriveConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticatorOnedriveConnection';
    ...
    */
     ...
     * Sets user_email
     *
     * @param string $user_email The email of the Onedrive account this is for
     *
     * @return self
     */
