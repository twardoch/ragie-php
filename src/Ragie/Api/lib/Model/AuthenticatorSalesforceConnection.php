 ...
 */
class AuthenticatorSalesforceConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticatorSalesforceConnection';
    ...
    */
     ...
     * Sets user_email
     *
     * @param string $user_email The email of the Salesforce account this is for
     *
     * @return self
     */
