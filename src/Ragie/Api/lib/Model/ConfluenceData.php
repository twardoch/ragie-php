...
/**
 * ConfluenceData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConfluenceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfluenceData';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['space_key'] === null) {
            $invalidProperties[] = "'space_key' can't be null";
        }
     ...
     * Sets space_key
     *
     * @param string $space_key space_key
     *
     * @return self
     */
    public function setSpaceKey($space_key)
    {
        if (is_null($space_key)) {
            throw new \InvalidArgumentException('non-nullable space_key cannot be null');
        }
