 ...
 */
class Connection2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Connection_2';
    ...
    public const PROVIDER_ZENDESK = 'zendesk';
    ...
    */
     ...
     * Sets user_email
     *
     * @param string $user_email The email the API key is associated with
     *
     * @return self
     */
