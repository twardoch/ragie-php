...
/**
 * ConnectionLimitParams Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConnectionLimitParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectionLimitParams';
    ...
    */
    ...
    public function setPageLimit($page_limit)
    {
        ...
        if (!is_null($page_limit) && ($page_limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_limit when calling ConnectionLimitParams., must be bigger than or equal to 1.');
        }
