...
/**
 * ConnectionSyncProgressWebhookPayload Class Doc Comment
 *
 * @category Class
 * @package  Ragie\Api
 * @author   OpenAPI Generator team
 ...
 */
class ConnectionSyncProgressWebhookPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectionSyncProgressWebhookPayload';
    ...
    protected static array $openAPINullables = [
        ...
        'updated_content_count' => false,
        'update_metadata_count' => false,
        'updated_metadata_count' => false,
        'delete_count' => false,
        'deleted_count' => false,
        'errored_count' => false
    ];
    ...
    protected static $setters = [
        ...
        'updated_content_count' => 'setUpdatedContentCount',
        'update_metadata_count' => 'setUpdateMetadataCount',
        'updated_metadata_count' => 'setUpdatedMetadataCount',
        'delete_count' => 'setDeleteCount',
        'deleted_count' => 'setDeletedCount',
        'errored_count' => 'setErroredCount'
    ];
    ...
    protected static $getters = [
        ...
        'updated_content_count' => 'getUpdatedContentCount',
        'update_metadata_count' => 'getUpdateMetadataCount',
        'updated_metadata_count' => 'getUpdatedMetadataCount',
        'delete_count' => 'getDeleteCount',
        'deleted_count' => 'getDeletedCount',
        'errored_count' => 'getErroredCount'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('created_count', $data ?? [], null);
        $this->setIfExists('update_content_count', $data ?? [], null);
        $this->setIfExists('updated_content_count', $data ?? [], null);
        $this->setIfExists('update_metadata_count', $data ?? [], null);
        $this->setIfExists('updated_metadata_count', $data ?? [], null);
        $this->setIfExists('delete_count', $data ?? [], null);
        $this->setIfExists('deleted_count', $data ?? [], null);
        $this->setIfExists('errored_count', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['updated_content_count'] === null) {
            $invalidProperties[] = "'updated_content_count' can't be null";
        }
        if ($this->container['update_metadata_count'] === null) {
            $invalidProperties[] = "'update_metadata_count' can't be null";
        }
        if ($this->container['updated_metadata_count'] === null) {
            $invalidProperties[] = "'updated_metadata_count' can't be null";
        }
        ...
        if ($this->container['errored_count'] === null) {
            $invalidProperties[] = "'errored_count' can't be null";
        }
    ...
    {
        if (is_null($created_count)) {
            throw new \InvalidArgumentException('non-nullable created_count cannot be null');
        }
    ...
    /**
     * Gets updated_content_count
     *
     * @return int
     */
    public function getUpdatedContentCount()
    {
        return $this->container['updated_content_count'];
    }

    /**
     * Sets updated_content_count
     *
     * @param int $updated_content_count updated_content_count
     *
     * @return self
     */
    public function setUpdatedContentCount($updated_content_count)
    {
        if (is_null($updated_content_count)) {
            throw new \InvalidArgumentException('non-nullable updated_content_count cannot be null');
        }
        $this->container['updated_content_count'] = $updated_content_count;
    ...
    /**
     * Gets updated_metadata_count
     *
     * @return int
     */
    public function getUpdatedMetadataCount()
    {
        return $this->container['updated_metadata_count'];
    }

    /**
     * Sets updated_metadata_count
     *
     * @param int $updated_metadata_count updated_metadata_count
     *
     * @return self
     */
    public function setUpdatedMetadataCount($updated_metadata_count)
    {
        if (is_null($updated_metadata_count)) {
            throw new \InvalidArgumentException('non-nullable updated_metadata_count cannot be null');
        }
        $this->container['updated_metadata_count'] = $updated_metadata_count;
     ...
     * @return int
     */
    public function getErroredCount()
    {
        return $this->container['errored_count'];
    }

    /**
     * Sets errored_count
     *
     * @param int $errored_count errored_count
     *
     * @return self
     */
    public function setErroredCount($errored_count)
    {
        if (is_null($errored_count)) {
            throw new \InvalidArgumentException('non-nullable errored_count cannot be null');
        }
        $this->container['errored_count'] = $errored_count;
