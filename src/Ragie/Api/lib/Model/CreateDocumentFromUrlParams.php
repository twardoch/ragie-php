 ...
 */
class CreateDocumentFromUrlParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDocumentFromUrlParams';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url Url of the file to download. Must be publicly accessible and HTTP or HTTPS scheme.
     *
     * @return self
     */
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $url when calling CreateDocumentFromUrlParams., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling CreateDocumentFromUrlParams., must be bigger than or equal to 1.');
        }
