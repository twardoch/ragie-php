 ...
 */
class DocumentChunkList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentChunkList';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['chunks'] === null) {
            $invalidProperties[] = "'chunks' can't be null";
        }
