 ...
 */
class FailedStep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FailedStep';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'failed');
