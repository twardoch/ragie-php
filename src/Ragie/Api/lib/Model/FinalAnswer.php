 ...
 */
class FinalAnswer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinalAnswer';
    ...
    */
     ...
     * Sets text
     *
     * @param string $text The final answer to the question.
     *
     * @return self
     */
