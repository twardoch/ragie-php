 ...
 */
class FinalAnswerEvidenceInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinalAnswer_evidence_inner';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'code_interpreter');
        $this->setIfExists('text', $data ?? [], null);
        $this->setIfExists('code', $data ?? [], null);
        $this->setIfExists('code_issue', $data ?? [], null);
        $this->setIfExists('code_result', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['code_result'] === null) {
            $invalidProperties[] = "'code_result' can't be null";
        }
     ...
     * Sets code_issue
     *
     * @param string $code_issue The issue that the code was written to solve.
     *
     * @return self
     */
     ...
     * Sets code_result
     *
     * @param string $code_result The result of the code that was executed.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id The chunk id of the evidence.
     *
     * @return self
     */
     ...
     * Sets index
     *
     * @param int $index The index of the chunk in the document.
     *
     * @return self
     */
     ...
     * Sets document_id
     *
     * @param string $document_id The document id of the document containing the chunk being used as evidence.
     *
     * @return self
     */
     ...
     * Sets document_name
     *
     * @param string $document_name The name of the document that contains the chunk being used as evidence.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata The metadata of the chunk being used as evidence.
     *
     * @return self
     */
     ...
     *
     * @param array<string,mixed>|null $document_metadata The metadata of the document that contains the evidence.
     *
     * @return self
     */
