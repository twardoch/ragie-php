...
/**
 * IntercomCredentials Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IntercomCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntercomCredentials';
    ...
    */
     ...
     * Sets user_email
     *
     * @param string $user_email The email of the Intercom account this is for
     *
     * @return self
     */
