...
/**
 * PartitionLimits Class Doc Comment
 *
 * @category Class
 * @package  Ragie\Api
 * @author   OpenAPI Generator team
 ...
 */
class PartitionLimits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartitionLimits';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pages_processed_limit_monthly']) && ($this->container['pages_processed_limit_monthly'] < 0)) {
            $invalidProperties[] = "invalid value for 'pages_processed_limit_monthly', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['pages_hosted_limit_monthly']) && ($this->container['pages_hosted_limit_monthly'] < 0)) {
            $invalidProperties[] = "invalid value for 'pages_hosted_limit_monthly', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['pages_processed_limit_max']) && ($this->container['pages_processed_limit_max'] < 0)) {
            $invalidProperties[] = "invalid value for 'pages_processed_limit_max', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['pages_hosted_limit_max']) && ($this->container['pages_hosted_limit_max'] < 0)) {
            $invalidProperties[] = "invalid value for 'pages_hosted_limit_max', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['video_processed_limit_monthly']) && ($this->container['video_processed_limit_monthly'] < 0)) {
            $invalidProperties[] = "invalid value for 'video_processed_limit_monthly', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['video_processed_limit_max']) && ($this->container['video_processed_limit_max'] < 0)) {
            $invalidProperties[] = "invalid value for 'video_processed_limit_max', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['audio_processed_limit_monthly']) && ($this->container['audio_processed_limit_monthly'] < 0)) {
            $invalidProperties[] = "invalid value for 'audio_processed_limit_monthly', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['audio_processed_limit_max']) && ($this->container['audio_processed_limit_max'] < 0)) {
            $invalidProperties[] = "invalid value for 'audio_processed_limit_max', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['media_streamed_limit_monthly']) && ($this->container['media_streamed_limit_monthly'] < 0)) {
            $invalidProperties[] = "invalid value for 'media_streamed_limit_monthly', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['media_streamed_limit_max']) && ($this->container['media_streamed_limit_max'] < 0)) {
            $invalidProperties[] = "invalid value for 'media_streamed_limit_max', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['media_hosted_limit_monthly']) && ($this->container['media_hosted_limit_monthly'] < 0)) {
            $invalidProperties[] = "invalid value for 'media_hosted_limit_monthly', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['media_hosted_limit_max']) && ($this->container['media_hosted_limit_max'] < 0)) {
            $invalidProperties[] = "invalid value for 'media_hosted_limit_max', must be bigger than or equal to 0.";
        }
    ...
    public function setPagesProcessedLimitMonthly($pages_processed_limit_monthly)
    {
        ...
        if (!is_null($pages_processed_limit_monthly) && ($pages_processed_limit_monthly < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_processed_limit_monthly when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setPagesHostedLimitMonthly($pages_hosted_limit_monthly)
    {
        ...
        if (!is_null($pages_hosted_limit_monthly) && ($pages_hosted_limit_monthly < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_hosted_limit_monthly when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setPagesProcessedLimitMax($pages_processed_limit_max)
    {
        ...
        if (!is_null($pages_processed_limit_max) && ($pages_processed_limit_max < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_processed_limit_max when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setPagesHostedLimitMax($pages_hosted_limit_max)
    {
        ...
        if (!is_null($pages_hosted_limit_max) && ($pages_hosted_limit_max < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_hosted_limit_max when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setVideoProcessedLimitMonthly($video_processed_limit_monthly)
    {
        ...
        if (!is_null($video_processed_limit_monthly) && ($video_processed_limit_monthly < 0)) {
            throw new \InvalidArgumentException('invalid value for $video_processed_limit_monthly when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setVideoProcessedLimitMax($video_processed_limit_max)
    {
        ...
        if (!is_null($video_processed_limit_max) && ($video_processed_limit_max < 0)) {
            throw new \InvalidArgumentException('invalid value for $video_processed_limit_max when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setAudioProcessedLimitMonthly($audio_processed_limit_monthly)
    {
        ...
        if (!is_null($audio_processed_limit_monthly) && ($audio_processed_limit_monthly < 0)) {
            throw new \InvalidArgumentException('invalid value for $audio_processed_limit_monthly when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setAudioProcessedLimitMax($audio_processed_limit_max)
    {
        ...
        if (!is_null($audio_processed_limit_max) && ($audio_processed_limit_max < 0)) {
            throw new \InvalidArgumentException('invalid value for $audio_processed_limit_max when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setMediaStreamedLimitMonthly($media_streamed_limit_monthly)
    {
        ...
        if (!is_null($media_streamed_limit_monthly) && ($media_streamed_limit_monthly < 0)) {
            throw new \InvalidArgumentException('invalid value for $media_streamed_limit_monthly when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setMediaStreamedLimitMax($media_streamed_limit_max)
    {
        ...
        if (!is_null($media_streamed_limit_max) && ($media_streamed_limit_max < 0)) {
            throw new \InvalidArgumentException('invalid value for $media_streamed_limit_max when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setMediaHostedLimitMonthly($media_hosted_limit_monthly)
    {
        ...
        if (!is_null($media_hosted_limit_monthly) && ($media_hosted_limit_monthly < 0)) {
            throw new \InvalidArgumentException('invalid value for $media_hosted_limit_monthly when calling PartitionLimits., must be bigger than or equal to 0.');
        }
    ...
    public function setMediaHostedLimitMax($media_hosted_limit_max)
    {
        ...
        if (!is_null($media_hosted_limit_max) && ($media_hosted_limit_max < 0)) {
            throw new \InvalidArgumentException('invalid value for $media_hosted_limit_max when calling PartitionLimits., must be bigger than or equal to 0.');
        }
