 ...
 */
class QueryDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueryDetails';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('search_effort', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['search_effort'] === null) {
            $invalidProperties[] = "'search_effort' can't be null";
        }
        if ($this->container['metadata_filter'] === null) {
            $invalidProperties[] = "'metadata_filter' can't be null";
        }
    ...
    {
        return $this->container['search_effort'];
    }
     ...
     * @return self
     */
    public function setSearchEffort($search_effort)
    {
        if (is_null($search_effort)) {
            throw new \InvalidArgumentException('non-nullable search_effort cannot be null');
        }
        $this->container['search_effort'] = $search_effort;
     ...
     *
     * @param array<string,mixed> $metadata_filter metadata_filter
     *
     * @return self
     */
