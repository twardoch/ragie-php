 ...
 */
class ResponsePatchdocumentmetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Patchdocumentmetadata';
