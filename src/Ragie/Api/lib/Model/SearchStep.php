 ...
 */
class SearchStep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchStep';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'base_search');
