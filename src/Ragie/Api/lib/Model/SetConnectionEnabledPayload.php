...
/**
 * SetConnectionEnabledPayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetConnectionEnabledPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetConnectionEnabledPayload';
    ...
    public const REASON_CONNECTION_OVER_TOTAL_PAGE_LIMIT = 'connection_over_total_page_limit';
    ...
    {
        return [
            self::REASON_CONNECTION_OVER_TOTAL_PAGE_LIMIT,
