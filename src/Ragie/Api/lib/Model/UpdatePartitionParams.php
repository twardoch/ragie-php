...
/**
 * UpdatePartitionParams Class Doc Comment
 *
 * @category Class
 * @package  Ragie\Api
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePartitionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePartitionParams';
    ...
    */
     ...
     * Sets context_aware
     *
     * @param bool|null $context_aware context_aware
     *
     * @return self
     */
    public function setContextAware($context_aware)
    {
        if (is_null($context_aware)) {
            array_push($this->openAPINullablesSetToNull, 'context_aware');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('context_aware', $nullablesSetToNull);
            if ($index !== FALSE) {
